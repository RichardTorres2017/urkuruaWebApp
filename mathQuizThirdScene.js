        ...
        document.getElementById('countdown').innerHTML = "";
         var s ="Error";
           ...
           // setTimeout('Redirect()', 100);
            ...
            window.location.href = "fourthScene.php" + queryString +"&score="+score;
    ...
    console.log("paso por aqui 2");
        ...
        if (answer == numberA + numberB) {
           ...
           // setTimeout('Redirect()', 100);
            var queryString = "?Message=" +s;
            document.getElementById('result').innerHTML = response;
                 setTimeout(function(){window.location.href = "thirdScene.php" + queryString +"&score="+score;}, 5000);
        ...
        //    <img src="bomb.images/bomb1">
           ...
           // setTimeout('Redirect()', 100);
            ...
            speak(response);
            document.getElementById('result').innerHTML = response;
                 setTimeout(function(){window.location.href = "fourthScene.php" + queryString +"&score="+score;}, 5000);
        }
